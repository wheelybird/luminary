...
$CONFIG_REGISTRY = array(
  ...
  'MFA_ENABLED' => array(
    'category' => 'mfa',
    'description' => 'Enable MFA/TOTP features',
    'help' => 'Requires TOTP schema to be installed in LDAP',
    'type' => 'boolean',
    'default' => false,
    'mandatory' => false,
    'env_var' => 'MFA_ENABLED',
  ...
  'AUDIT_LOG_FILE' => array(
    ...
    'help' => 'Full path to audit log file',
    'type' => 'string',
  ...
  'PASSWORD_POLICY_ENABLED' => array(
    ...
    'help' => 'Server-side validation of password requirements',
    'type' => 'boolean',
    'default' => false,
    'mandatory' => false,
  ...
  'PASSWORD_HISTORY_COUNT' => array(
    ...
    'help' => 'Number of previous passwords to check (0=disabled)',
    'type' => 'integer',
    'default' => 0,
    'mandatory' => false,
  ...
  'PASSWORD_EXPIRY_DAYS' => array(
    ...
    'help' => 'Days until password expires (0=never)',
    'type' => 'integer',
    'default' => 0,
    'mandatory' => false,
...
$MFA_ENABLED = ((strcasecmp(getenv('MFA_ENABLED'),'TRUE') == 0) ? TRUE : get_config_default('MFA_ENABLED'));
